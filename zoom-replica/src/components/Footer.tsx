...
export default function Footer() {
  return (
    <footer className="bg-zoom-navy text-white">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-10 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10">
          {/* Brand column */}
          <div className="lg:col-span-1">
            <Image
              src="https://st1.zoom.us/homepage/20260825-1235/primary/dist/assets/zoommedia/logo-zoom-white@2x.png"
              alt="Zoom"
              width={88}
              height={20}
            ...
            <div className="bg-white/5 rounded-xl p-4 mb-6">
              <div className="flex items-center gap-3">
                <Download className="w-5 h-5 text-zoom-blue" />
                <div>
                  <p className="text-sm font-medium">Download Center</p>
            ...
            <div className="space-y-3 mb-6">
              <button className="flex items-center justify-between w-full px-4 py-2.5 text-sm bg-white/5 border border-white/10 rounded-lg">
                English
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-white/60">+1.888.799.9666</p>
              <p className="text-sm text-white/60">+1.888.303.1012</p>
            </div>
